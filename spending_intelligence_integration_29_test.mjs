...
assert(s.meta.schemaVersion===42,'29.6 migrates Spending Intelligence state to schema 42');assert(Array.isArray(s.netWorthBook.items)&&Array.isArray(s.netWorthBook.history),'schema 42 net worth collections coexist with spending');assert(s.projects[0].name==='Legacy work','legacy state preserved');
