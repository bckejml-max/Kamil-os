...
if(major<483){if(!process.exitCode)console.log(`OS483 Morning Director guard skipped · release ${appVersion}`);process.exit()}
...
if(!process.exitCode)console.log(`OS483 Morning Director guard OK · release ${appVersion}`);
