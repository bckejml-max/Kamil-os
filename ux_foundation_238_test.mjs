...
assert(js.includes("e.altKey")&&js.includes("Shift+D")===false,'OS233 shortcuts missing');
...
assert(sw.includes('kamil-os-238.0.0-core-r1')&&sw.includes('uxFoundation238.js')&&sw.includes('uxFoundation238.css'),'OS238 cache wiring missing');
