...
const directMore=more.includes('Self-Improving OS')&&more.includes("import('./selfImproving892.js')");
const legacyGateway=more.includes('Pokročilé / legacy')&&one977.includes("self:['./selfImproving892.js','openSelfImproving892']");
if(!(directMore||legacyGateway)||!more.includes('trackMore892'))throw new Error('OS892 must remain reachable from More directly or through OS977 legacy gateway');
