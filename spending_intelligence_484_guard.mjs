...
const boot=read('./js/instantShell64.js'),mod=read('./js/spendingIntelligence484.js'),money=read('./js/personalMoney640.js'),workspace=read('./js/appWorkspace211.js'),css=read('./spendingIntelligence484.css'),release=read('./js/releaseMeta.js'),sw=read('./sw.js'),pkg=read('./package.json');
...
if(!workspace.includes('[data-spending484-anchor]'))fail('OS211 must keep OS484 outside no-scroll paging');
