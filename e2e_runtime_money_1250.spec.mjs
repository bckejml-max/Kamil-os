...
test('OS1250 keeps Money hub ownership stable across repeated refreshes',async({page})=>{
 ...
 await page.waitForFunction(()=>document.querySelector('[data-money-hub680]')&&window.__KAMIL_MONEY_HUB680__?.healthy===true,{timeout:15000});
 ...
 await expect(page.locator('[data-money-hub680]')).toBeVisible();
});
