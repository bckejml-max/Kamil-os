...
test('64.3 Quick Add creates a personal waiting item',async({page})=>{
 await page.goto(BASE,{waitUntil:'domcontentloaded'});
 await page.getByRole('button',{name:/Přidat osobní věc/i}).click();
