...
assert.match(migration,/create table if not exists public\.ticket_gmail_state1215/i);
assert.match(migration,/create table if not exists public\.ticket_gmail_sync1215/i);
assert.match(migration,/create or replace function public\.commit_ticket_gmail_batch1215/i);
