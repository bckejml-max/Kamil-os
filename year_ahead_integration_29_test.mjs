...
assert(s.meta.schemaVersion===41,'schema migrated to v41');assert(Array.isArray(s.personalSpending.transactions)&&Array.isArray(s.importCenter.history),'29.4 import arrays coexist with Year Ahead');
