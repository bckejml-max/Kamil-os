...
export async function openRecheckTriggers562(){
 ...
 const choice=await modal('XTB + vstupenky / Recheck Triggers 56.2',body,[{label:'Decision Changes 56.3',value:'changes',primary:true},{label:'Zavřít',value:null}]);
 if(choice==='changes'){const m=await import('./decisionChangeTracker563.js');return m.openDecisionChangeTracker563()}
 return choice;
}
