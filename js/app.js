...
const mobileMenu=qs('#mobileMenuBtn');if(mobileMenu)mobileMenu.onclick=async()=>{
 const names={today:'Dnes',work:'Práce',tickets:'Vstupenky',property:'Reality',money:'Peníze',betting:'Sázení',inbox:'Inbox',family:'Rodina',home:'Domov',more:'Dokumenty'};
