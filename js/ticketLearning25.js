...
export function applyTicketLearning(opportunity,s={},decision={}){
 ...
 // Historical evidence may only downgrade an automatic BUY when the category sample is meaningful.
 // Fresh live intelligence remains authoritative for action; history still constrains position size.
