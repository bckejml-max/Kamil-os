...
export function renderBettingOverview(){
 ...
 if(!host.dataset.bettingOverviewBound){host.dataset.bettingOverviewBound='1';ownEvent1100(OWNER,host,'click',async e=>{if(e.target.closest('[data-betting-task]')){window.dispatchEvent(new CustomEvent('kamil:capture',{detail:'task'}));return}if(e.target.closest('[data-betting-advanced]')){await loadProductAdvancedStyles(["./globalFintech137.css"]);const m=await import('./bettingAdvanced527.js');await m.renderBettingPage527?.()}})}
