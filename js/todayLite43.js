...
let fullModule=null,fullPromise=null,seq=0,financePromise=null,lifePromise=null,assistantPromise=null,decisionPromise=null,actionQueuePromise=null,commanderPromise=null;
...
export function renderTodayLite43(){
 ...
 host.innerHTML=`<div class="view-head"><div><div class="eyebrow">KAMIL OS ${APP_VERSION} / MARKET HOME 58.8</div><h1>XTB + vstupenky. Co přesně udělat teď?</h1><p>Jedním kliknutím otevře finální Market Commander 58.7. Všechny těžší výpočty zůstávají lazy a spustí se až po kliknutí.</p></div><div class="row-actions"><button class="btn primary" data-market-commander-587>Market Commander</button><button class="btn" data-action-queue-559>Akční fronta</button><button class="btn" data-decision-534>Rozhodnutí</button><button class="btn" data-open-money>XTB</button><button class="btn" data-open-tickets>Vstupenky</button></div></div>
 ...
 <div class="card"><div class="eyebrow">MARKET COMMANDER 58.7</div><div class="card-head"><div><h2>Jeden finální market krok</h2><p class="muted">Decision + readiness + confidence + konflikty + sizing + sequence risk + 20 nových XTB/ticket vrstev. Vše až po kliknutí.</p></div><button class="btn primary" data-market-commander-587>Co mám udělat teď</button></div></div>
 <div class="card"><div class="card-head"><div><div class="eyebrow">SMART TOP 3 · XTB + VSTUPENKY</div><h2>Co má největší smysl řešit teď?</h2></div><button class="btn primary" data-market-commander-587>Otevřít Commander</button></div>${cardRows(priorityRows,'XTB ani vstupenky teď podle uložených dat nevyžadují zásah.')}</div>
 <div class="card"><div class="eyebrow">ACTION QUEUE 55.9</div><div class="card-head"><div><h2>UDĚLEJ TEĎ · NEJDŘÍV OVĚŘ · DRŽ & ČEKEJ</h2><p class="muted">Detailní fronta zůstává dostupná jako diagnostika pod Commanderem.</p></div><button class="btn" data-action-queue-559>Otevřít akční frontu</button></div></div>
...
// Legacy compatibility markers: Dnes řeš to důležité. Zbytek může počkat. · Personal 45.5 drží Safe Core · data-life-dashboard · import('./lifeDashboard455.js') · Životní dashboard · Můj život na jedné obrazovce. · Moje finance / 44.5 · data-assistant-530 · MARKET COCKPIT 53.4 · Rozhodnutí 53.4
