...
let fullModule=null,fullPromise=null,seq=0,financePromise=null,lifePromise=null,assistantPromise=null,decisionPromise=null,actionQueuePromise=null;
...
export function renderTodayLite43(){
 ...
 host.innerHTML=`<div class="view-head"><div><div class="eyebrow">KAMIL OS ${APP_VERSION} / MARKET HOME 56.0</div><h1>XTB + vstupenky. Co přesně udělat teď?</h1><p>Hlavní stránka zůstává lehká. Jedním kliknutím otevře finální Action Queue 55.9 se sizingem, floor cenami a repricingem.</p></div><div class="row-actions"><button class="btn primary" data-action-queue-559>Akční fronta</button><button class="btn" data-decision-534>Rozhodnutí</button><button class="btn" data-open-money>XTB</button><button class="btn" data-open-tickets>Vstupenky</button></div></div>
 ...
 <div class="card"><div class="card-head"><div><div class="eyebrow">SMART TOP 3 · XTB + VSTUPENKY</div><h2>Co má největší smysl řešit teď?</h2></div><button class="btn primary" data-action-queue-559>Otevřít akční frontu</button></div>${cardRows(priorityRows,'XTB ani vstupenky teď podle uložených dat nevyžadují zásah.')}</div>
 <div class="card"><div class="eyebrow">ACTION QUEUE 55.9</div><div class="card-head"><div><h2>UDĚLEJ TEĎ · NEJDŘÍV OVĚŘ · DRŽ & ČEKEJ</h2><p class="muted">Finální verdikt, readiness, confidence a konflikty se spočítají až po kliknutí. Home tím zůstává stejně lehký.</p></div><button class="btn primary" data-action-queue-559>Co přesně udělat</button></div></div>
