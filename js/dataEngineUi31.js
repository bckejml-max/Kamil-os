...
const shell=()=>`<div class="card"><div class="card-head"><div><div class="eyebrow">CORE V2 / DATA ENGINE 31.3</div><h2>IndexedDB history mirror</h2><p class="muted">Dlouhá historie má vlastní lokální úložiště. 31.3 pouze zrcadlí data; z hlavního state nic nemaže.</p></div><span class="status warn">NAČÍTÁM</span></div><div class="decision-note">Kontroluji lokální IndexedDB. Hlavní state zůstává beze změny.</div></div>`;
async function render(){
 ...
 const s=await dataEngineStatus31();if(n!==seq||!host.isConnected)return;
