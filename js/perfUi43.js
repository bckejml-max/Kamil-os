...
function diagnostics(){
 ...
 const shell=Number(window.__KAMIL_INSTANT_SHELL_AT__),app=Number(window.__KAMIL_APP_READY_AT__),today=Number(window.__KAMIL_TODAY_FULL_AT__),readyMode=String(window.__KAMIL_APP_READY_MODE__||'—'),snapshot=window.__KAMIL_SNAPSHOT_HIT__===true;
 ...
 return {storage,nav,long,preboot,shell,app,today,readyMode,snapshot,bottleneck};
}
function tile(){
