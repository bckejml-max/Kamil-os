...
function keepCanonicalVisualLast(){const links=[...document.querySelectorAll('link[rel="stylesheet"]')],product=links.find(x=>x.getAttribute('href')==='./productReset1300.css'||x.href.endsWith('/productReset1300.css')),os1400=links.find(x=>x.getAttribute('href')==='./os1400.css'||x.href.endsWith('/os1400.css')),os1500=links.find(x=>x.getAttribute('href')==='./os1500.css'||x.href.endsWith('/os1500.css'));if(product&&product!==document.head.lastElementChild)document.head.appendChild(product);if(os1400&&os1400!==document.head.lastElementChild)document.head.appendChild(os1400);if(os1500&&os1500!==document.head.lastElementChild)document.head.appendChild(os1500)}
