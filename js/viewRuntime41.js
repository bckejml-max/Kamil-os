...
function keepCanonicalVisualLast(){const links=[...document.querySelectorAll('link[rel="stylesheet"]')],visual=links.find(x=>x.getAttribute('href')==='./os737.css'||x.href.endsWith('/os737.css')),product=links.find(x=>x.getAttribute('href')==='./productReset1300.css'||x.href.endsWith('/productReset1300.css'));if(visual&&visual!==document.head.lastElementChild)document.head.appendChild(visual);if(product&&product!==document.head.lastElementChild)document.head.appendChild(product)}
