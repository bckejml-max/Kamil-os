...
function keepCanonicalVisualLast(){const product=[...document.querySelectorAll('link[rel="stylesheet"]')].find(x=>x.getAttribute('href')==='./productReset1300.css'||x.href.endsWith('/productReset1300.css'));if(product&&product!==document.head.lastElementChild)document.head.appendChild(product)}
