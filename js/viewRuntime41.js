...
ensureInboxShell();syncChrome142('today');
window.addEventListener?.('kamil:view-change',e=>syncChrome142(e.detail));
const viewDefs={today:['./todayPage101.js','renderTodayPage101'],inbox:['./inboxPage141.js','renderInboxPage141'],money:['./moneyPage100.js','renderMoneyPage100'],tickets:['./ticketPage100.js','renderTicketPage100'],family:['./familyPage140.js','renderFamilyPage140'],home:['./homePage140.js','renderHomePage140'],more:['./documentsPage141.js','renderDocumentsPage141']};
...
export async function openCapture41(type='task'){
 ...
 const m=await load('./personalCapture643.js');
 if(type==='family-task')return m.openPersonalCapture643('task',{area:'Rodina',category:'Rodina'});
 if(type==='home-task')return m.openPersonalCapture643('task',{area:'Domov',category:'Domov'});
