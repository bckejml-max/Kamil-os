...
export function renderMoneyOverview(){
 ...
 const stateBlock='<section class="pr1320-now pr1327-money-state"><div><div class="pr1300-kicker">'+(complete?'Čisté jmění':'Známý stav')+'</div><h2>'+headline+'</h2><p>'+detail+'</p></div><div class="pr1320-now-actions"><button class="pr1300-btn" type="button" data-money-advanced>Detail financí</button></div></section>';
 const attentionBlock=d.attention.length?'<section class="pr1300-panel pr1327-money-attention"><div class="pr1300-panel-head"><h2>Teď řešit</h2><span>'+d.attention.length+' otevřené</span></div>'+attentionHtml(d.attention)+'</section>':'';
 host.innerHTML='<div class="pr1300-shell" data-money-overview>' +
  '<div class="pr1300-head"><div><div class="pr1300-kicker">Peníze</div><h1>Co je potřeba udělat s penězi.</h1><p>Nejdřív otevřené finanční věci. Souhrn majetku a analytika jsou až potom.</p></div><span class="pr1300-status '+(d.attention.length?'warn':'good')+'">'+(d.attention.length?d.attention.length+' k řešení':'klid')+'</span></div>' +
  attentionBlock +
  stateBlock +
  ...
  (!d.attention.length?'<div class="pr1300-empty pr1327-money-clear">Nic finančního teď nevyžaduje zásah.</div>':'') +
