...
export function renderMoneyOverview(){
 ...
 const d=data(),complete=d.property>0&&d.bank>0&&(d.invest>0||d.tickets>0),primary=d.attention[0]||null,rest=d.attention.slice(1);
 ...
 window.__KAMIL_MONEY_OVERVIEW__={healthy:true,attention:d.attention.length,primary:primary?.title||null,net:d.net,decisionSurface:1334,at:Date.now()};return true;
}
