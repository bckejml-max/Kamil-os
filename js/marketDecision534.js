...
export async function openMarketDecision534(){
 ...
 const choice=await modal('XTB + vstupenky / Rozhodnutí 53.4',body,[{label:'Otevřít XTB',value:'money'},{label:'Otevřít vstupenky',value:'tickets'},{label:'Zavřít',value:null,primary:true}]);
