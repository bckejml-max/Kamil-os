export const APP_VERSION='29.9.0';
export const APP_RELEASE='29.9';
...
const start=()=>{
 stamp();
 new MutationObserver(()=>queueMicrotask(stamp)).observe(document.body,{childList:true,subtree:true});
};
