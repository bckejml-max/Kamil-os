...
function render(){
 ...
 const populated=best?'<section class="pr1320-now"><div><div class="pr1300-kicker">Teď</div><h2>'+esc(best.name)+'</h2><p>'+esc(best.location||'Lokalita neuvedena')+' · '+esc(best.decision.reason)+'</p></div><div class="pr1320-now-actions"><button class="pr1300-btn primary" type="button" data-property1300-task>＋ Úkol k realitě</button></div></section><div class="pr1320-meta"><span>Rozhodnutí: '+esc(best.decision.action)+'</span><span>Net yield: '+pct(best.netYield)+'</span><span>Vlastní zdroje: '+money(own)+'</span><span>CF po hypotéce: '+(cf!==null?(cf>=0?'+':'')+money(cf):'—')+'</span></div><section class="pr1300-panel"><div class="pr1300-panel-head"><h2>Shortlist</h2><button class="pr1300-btn" type="button" data-property1300-money>Finanční detail</button></div>'+candidateRows(m.rows)+'</section><details class="pr1300-panel"><summary class="pr1300-panel-head"><h3>Detail #1</h3><span>'+esc(best.name)+'</span></summary><div class="pr1300-row"><div class="pr1300-row-main"><b>Kupní cena</b><small>aktuální vstup</small></div><div class="pr1300-row-side">'+money(best.purchasePrice)+'</div></div><div class="pr1300-row"><div class="pr1300-row-main"><b>Cílová cena</b><small>hranice podle Deal Score</small></div><div class="pr1300-row-side">'+(best.targetPrice?money(best.targetPrice):'—')+'</div></div><div class="pr1300-row"><div class="pr1300-row-main"><b>Downside yield</b><small>horší scénář</small></div><div class="pr1300-row-side">'+pct(best.downsideYield)+'</div></div></details>':'<section class="pr1320-now pr1328-property-empty"><div><div class="pr1300-kicker">Shortlist</div><h2>Zatím žádný kandidát</h2><p>Přidej investiční byt do Property Booku. Jakmile jsou data uložená, OS ukáže pořadí a Deal Score.</p></div><div class="pr1320-now-actions"><button class="pr1300-btn primary" type="button" data-property1300-task>＋ Úkol k realitě</button><button class="pr1300-btn" type="button" data-property1300-money>Peníze</button></div></section>';
 host.innerHTML='<div class="pr1300-shell" data-property-page1300>' +
  '<div class="pr1300-head"><div><div class="pr1300-kicker">Reality</div><h1>Investiční byty jako samostatné rozhodnutí.</h1><p>Nejdřív nejlepší kandidát a rozhodnutí. Prázdný shortlist nevyrábí falešné metriky.</p></div><span class="pr1300-status '+(best?decisionTone(best.decision.code):'')+'">'+m.rows.length+' kandidátů</span></div>' +
  populated +
 '</div>';
