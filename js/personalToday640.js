...
export function renderPersonalToday640(){
 ...
 const quick=late?`<section class="ux65-quick"><button class="btn primary" data-daily-close>Uzavřít den</button></section>`:`<section class="ux65-quick"><button class="btn" data-ask="Co mám dnes řešit?">Co dnes řešit?</button><button class="btn" data-ask="Co mi končí?">Co mi končí?</button><button class="btn" data-ask="Na co čekám?">Na co čekám?</button><button class="btn" data-daily-close>${rhythm.mode==='evening'?'Uzavřít den':'Denní přehled'}</button></section>`;
