...
function decorate213(){
 ...
 shell.querySelectorAll('[data-action213]').forEach(button=>button.addEventListener('click',()=>findSource213(host,button.dataset.action213)?.click()));
