...
export function renderTasksOverview(){
 ...
 '<div class="pr1320-meta"><span>Odpovědět: '+m.counts.reply+'</span><span>Vyřešit: '+m.counts.do+'</span><span>Čekám: '+m.counts.waiting+'</span><span>Termíny: '+m.counts.deadline+'</span></div>' +
 '<section class="pr1300-panel"><div class="pr1300-panel-head"><h2>Fronta</h2><button class="pr1300-btn" type="button" data-task-advanced>Celá fronta + Gmail</button></div>'+rows(m.rows)+'</section>' +
