...
function ensureStyle(){const styles=[['dashboard110','./dashboard110.css'],['dashboard1103','./dashboard1103.css'],['os111','./os111.css'],['os112','./os112.css'],['os113','./os113.css'],['os114','./os114.css'],['os115','./os115.css'],['os116','./os116.css'],['os117','./os117.css'],['os118','./os118.css'],['os119','./os119.css'],['os120','./os120.css'],['os121','./os121.css'],['os122','./os122.css']];for(const [key,href] of styles){if(!document.querySelector(`link[data-${key}]`)){const l=document.createElement('link');l.rel='stylesheet';l.href=href;l.setAttribute(`data-${key}`,'1');document.head.appendChild(l)}}}
export function renderTodayPage101(){ensureStyle();renderDashboard1103().then(()=>{enhanceXtbReview110();return enhanceOS111()}).then(()=>enhanceOS112()).then(()=>enhanceOS113()).then(()=>enhanceOS114()).then(()=>enhanceOS115()).then(()=>enhanceOS116()).then(()=>enhanceOS117()).then(()=>enhanceOS118()).then(()=>enhanceOS119()).then(()=>enhanceOS120()).then(()=>enhanceOS121()).then(()=>enhanceOS122()).catch(e=>{console.error('[dashboard122]',e);renderPersonalToday640()})}
