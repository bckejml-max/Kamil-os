...
function render(){
 ...
 host.innerHTML=`<div class="card-head"><div><div class="eyebrow">ÚSPORY / RENEWAL RADAR / 26.2</div><h2>Co prověřit před prodloužením</h2></div><button class="btn" id="renewalOpenContracts26">Smlouvy</button></div>
