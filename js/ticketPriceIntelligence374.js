...
export function installTicketPriceIntelligence374(){if(document.documentElement.dataset.ticketPrice374Installed==='1')return;document.documentElement.dataset.ticketPrice374Installed='1';window.addEventListener('kamil:view-change',e=>{if(e.detail==='tickets')schedule(700)});window.addEventListener('kamil:ticket-targets372-updated',()=>schedule(300));const host=document.querySelector('#ticketIntelView');if(host){const mo=new MutationObserver(()=>schedule(180));mo.observe(host,{childList:true,subtree:true});window.__KAMIL_TICKET_PRICE374_OBSERVER__=mo}schedule(1200)}
