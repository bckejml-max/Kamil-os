...
const groups={
 today:{css:['../styles24.css','../decision24.css','../live24.css','../personal26.css','../autopilot28.css','../os34.css','../os35.css','../lifeOs42.css','../platform43.css'],primary:['./lifeOs42Ui.js','./directorUi34.js','./followUpUi35.js','./emailWorkflowUi35.js','./focusActionUi35.js','./os40ExecutiveUi.js'],secondary:['./platform43Ui.js','./deadlineRadarUi35.js','./todayBrainUi34.js','./changePulseUi35.js']},
 ...
 more:{css:['../capture24.css','../personal26.css','../autopilot28.css','../os35.css'],primary:['./autopilotNavBridge28.js','./personalPlusNav29.js','./os40KnowledgeUi.js'],secondary:['./decisionExplainUi30.js','./decisionJournalUi31.js','./profileBootstrapUi31.js','./systemHealthUi31.js','./liveBrainUi32.js','./dataEngineUi31.js','./recoveryShieldUi32.js','./smartSyncUi31.js','./remoteInboxUi31.js']}
};
...
function safeMode(){try{return !!JSON.parse(localStorage.getItem('kamil-os-platform43')||'{}')?.safeMode}catch{return false}}
function loadGroup(name,{staged=true}={}){let g=groups[name]||{css:[],primary:[],secondary:[]};if(safeMode()){g={...g,primary:name==='today'?g.primary.slice(0,1):g.primary.slice(0,1),secondary:name==='today'?['./platform43Ui.js']:[]}}const first=Promise.allSettled([...g.css.map(loadStyle),...g.primary.map(loadModule)]);if(staged&&g.secondary.length)first.finally(()=>setTimeout(()=>idle(()=>Promise.allSettled(g.secondary.map(loadModule)),3000),2500));else if(g.secondary.length)g.secondary.forEach(loadModule);return first}
