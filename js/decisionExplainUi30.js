...
function decorate(){
 ...
 rows.forEach((row,index)=>{
  ...
  const key=keyOf(decision),b=document.createElement('button');b.type='button';b.className='btn';b.textContent='Proč teď?';b.setAttribute(BUTTON_ATTR,key);b.setAttribute('aria-label',`Vysvětlit prioritu rozhodnutí ${index+1}`);b.addEventListener('click',()=>showWhy(key));
