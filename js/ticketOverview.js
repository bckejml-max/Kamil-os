...
export function renderTicketOverview(){
 ...
 '<section class="pr1300-panel"><div class="pr1300-panel-head"><h2>Potřebuje pozornost</h2><button class="pr1300-btn" type="button" data-ticket-advanced>Pokročilý ticket desk</button></div>'+attentionHtml(d.attention)+'</section>' +
 '<section class="pr1300-panel"><div class="pr1300-panel-head"><h3>Aktivní eventy</h3><span>nejvyšší priorita nahoře</span></div>'+eventRows(d.p.events)+'</section>' +
