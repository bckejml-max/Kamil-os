...
function ensureVisualStyle(){for(const [key,href] of [['ticketvisual132','./ticketVisual132.css'],['ticketvisual133','./ticketVisual133.css'],['ticketvisual134','./ticketVisual134.css'],['ticketvisual135','./ticketVisual135.css'],['ticketvisual136','./ticketVisual136.css']]){if(document.querySelector(`link[data-${key}]`))continue;const l=document.createElement('link');l.rel='stylesheet';l.href=href;l.setAttribute(`data-${key}`,'1');document.head.appendChild(l)}}
function enhance(){if(pending)return;pending=true;queueMicrotask(async()=>{pending=false;try{await appendTicketIntelligence100();await appendTicketDetails100();await applyTicketPriceFix102();await enhanceTicketSector103();await enhanceTicketRepricing105();await enhanceTicketVisual132();await enhanceTicketVisual133();await enhanceTicketVisual134();await enhanceTicketVisual135();await enhanceTicketVisual136();await applyTicketDataQa144()}catch(e){console.warn('[tickets144]',e)}})}
