...
test('Market Home 56.0 exposes Action Queue directly while keeping it lazy',async({page})=>{
 ...
 await expect(page.locator('#todayView')).toContainText('MARKET HOME 56.0');
