...
assert(s.meta.schemaVersion===SCHEMA_VERSION,`Ticket Profit state migrates to canonical schema ${SCHEMA_VERSION}`);const ledger=ticketProfitLedger(s),lessons=ticketLessons(s),groups=ticketEventGroups(s),czk=ledger.byCurrency.CZK;
...
console.log('TICKET PROFIT & ROI INTEGRATION PASS');
