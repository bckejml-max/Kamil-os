...
for(const f of ['js/controlPlane1037.js','js/controlPlane1037Boot.js','js/runtimeCoordinator1050.js','js/personalMore640.js','js/bettingBootstrap543.js'])assert.ok(fs.existsSync(f),`missing ${f}`);
for(const f of ['js/controlPlane1037.js','js/controlPlane1037Boot.js','js/runtimeCoordinator1050.js','js/personalMore640.js','js/bettingBootstrap543.js'])execFileSync(process.execPath,['--check',f],{stdio:'pipe'});
const c=read('js/controlPlane1037.js'),boot=read('js/bettingBootstrap543.js'),runtime=read('js/runtimeCoordinator1050.js'),compat=read('js/controlPlane1037Boot.js'),more=read('js/personalMore640.js');
