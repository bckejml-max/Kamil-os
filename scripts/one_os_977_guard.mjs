...
const one=read('js/oneOS977.js'),more=read('js/personalMore640.js'),boot=read('js/bettingBootstrap543.js'),runtime=read('js/runtimeCoordinator1050.js'),compat=read('js/oneOS977Boot.js'),control=fs.existsSync('js/controlPlane1037.js')?read('js/controlPlane1037.js'):'';
...
need(compat.includes('scheduleRuntime1050'),'OS977 compatibility boot must delegate');
need(runtime.includes("'./oneOS977.js','installOneOS977'"),'OS977 installer missing from runtime coordinator');
need(boot.includes("import('./runtimeCoordinator1050.js')"),'OS1050 bootstrap missing');
need(!boot.includes("import('./oneOS977Boot.js')"),'legacy OS977 direct bootstrap returned');
