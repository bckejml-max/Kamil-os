const CACHE='kamil-os-64.3-personal-capture-r1';
const SHELL=[
  ...
  './js/personalActionExecution641.js','./js/personalVaultEdit641.js','./js/personalFollowup642.js','./js/personalCapture643.js',
