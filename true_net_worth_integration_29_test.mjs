...
assert(s.meta.schemaVersion===SCHEMA_VERSION,`schema 41 migrated to canonical ${SCHEMA_VERSION}`);assert(Array.isArray(s.netWorthBook.items)&&Array.isArray(s.netWorthBook.history),'netWorthBook collections created');
...
console.log('TRUE NET WORTH INTEGRATION PASS');
