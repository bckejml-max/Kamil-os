...
globalThis.fetch=async(url)=>{
 ...
 if(s.includes('o2arena.cz'))return new Response(`<html><body><h1>Test Event 2026</h1><a href="https://www.ticketmaster.cz/event/test-event">Koupit vstupenky</a></body></html>`,{status:200,headers:{'content-type':'text/html'}});
 if(s.includes('ticketmaster.cz'))return new Response(`<html><body><h1>Test Event 2026</h1><div>Koupit vstupenky · Cena Kč 1900</div></body></html>`,{status:200,headers:{'content-type':'text/html'}});
...
const req={method:'POST',url:'https://kamil-os.test/api/ticket-market-watch',json:async()=>({items:[
 {id:'x',label:'Test Event - 405',event:'Test Event',date:'2026-09-19',section:'405',qty:3,buyEachCzk:1800,status:'NOT_LISTED',viagogoUrl:'https://www.viagogo.com/ww/E-1',officialUrl:'https://www.o2arena.cz/test-event'},
