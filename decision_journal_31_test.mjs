...
const secret=decisionJournalEntry({...d,observed:{password:'x',pnlPct:1}},now);assert(secret.observed.password==='x','engine stores provided observed fields; caller must only pass safe fields');
