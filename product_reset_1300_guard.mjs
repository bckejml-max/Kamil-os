...
assert.match(moneyOverview,/data-money-overview/);assert.match(moneyOverview,/Detail financí/);assert.match(moneyOverview,/moneyAdvanced100\.js/);
assert.match(ticketOverview,/data-ticket-overview/);assert.match(ticketOverview,/Synchronizovat Viagogo/);assert.match(ticketOverview,/ticketAdvanced100\.js/);
assert.match(bettingOverview,/data-betting-overview/);assert.match(bettingOverview,/Scanner a detail sázek/);assert.match(bettingOverview,/bettingAdvanced527\.js/);
assert.match(tasksOverview,/data-tasks-overview/);assert.match(tasksOverview,/Úkoly a čekání/);assert.match(tasksOverview,/inboxAdvanced141\.js/);
assert.match(css,/Historical experimental decorators/);assert.match(css,/\[data-today-hub650\]/);assert.match(css,/repeat\(7,minmax\(0,1fr\)\)/);
