...
test('OS1305 exposes cloud login controls when local mode asks to connect',async({page})=>{
 await boot(page);
...
test('OS1305 mobile menu reaches secondary personal sections',async({page})=>{
 await page.setViewportSize({width:390,height:844});
 await boot(page);
